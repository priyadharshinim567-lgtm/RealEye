...
**📂 Project Structure**
    ...
    RealEye/
    ├── dataset/              # Training & testing images (Real & AI-generated)
    ├── model/
    │   ├── cnn_model.py      # CNN network architecture design
    │   └── realeye_model.keras # Saved trained model weights
    ├── preprocessing/
    │   └── preprocess.py     # Image normalization and augmentation pipelines
    ├── utils/
    │   └── gradcam.py        # Grad-CAM heatmap visualization logic
    ├── app.py                # Main Streamlit web application script
    ├── train_model.py        # Model training and optimization script
